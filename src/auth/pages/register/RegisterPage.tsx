...
// ComponentProps alloww to take any props that a div can take
...
export const RegisterPage = () => {
    ...
    const handleRegister = async (event: FormEvent<HTMLFormElement>) => {
        ...
        console.log('*******************************************');
        const isValid = await registerUser(email, password, fullName);
        console.log({ isValid });
                    ...
                    <form className="p-6 md:p-8" onSubmit={handleRegister}>
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input id="password" name="password" type="password" required placeholder="Contraseña" autoComplete="off" />
                            </div>
